...
if(/(MicroMessenger|QQ|Alipay)/i.test(navigator.userAgent)&&!/(QQBrowser)/i.test(navigator.userAgent)){var title="";var subtitle="";document.getElementById("h").removeChild(document.getElementById("i"));document.getElementById("pending").removeChild(document.getElementById("depends"));document.getElementById("btncontainer").removeChild(document.getElementById("qrcodeclose"));console.log("REMOVAL DONE");}
